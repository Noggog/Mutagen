...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IPatrol
    {
        ...
        {
            return PatrolCommon.Instance.EnumerateFormLinks<TMajorGetter>(this);
        }
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    internal partial class PatrolCommon
    {
        ...
        public IEnumerable<IFormLinkGetter<TMajorGetter>> EnumerateFormLinks<TMajorGetter>(IPatrolGetter obj)
            where TMajorGetter : class, IMajorRecordGetter
        {
