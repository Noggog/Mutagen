...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        ILoquiObjectSetter<Effect>
    {
        ...
        {
            return EffectCommon.Instance.EnumerateFormLinks<TMajorGetter>(this);
        }
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    internal partial class EffectCommon
    {
        ...
        public IEnumerable<IFormLinkGetter<TMajorGetter>> EnumerateFormLinks<TMajorGetter>(IEffectGetter obj)
            where TMajorGetter : class, IMajorRecordGetter
        {
