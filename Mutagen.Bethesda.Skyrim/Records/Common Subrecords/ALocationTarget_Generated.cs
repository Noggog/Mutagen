...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        ILoquiObjectSetter<ALocationTarget>
    {
        ...
        {
            return ALocationTargetCommon.Instance.EnumerateFormLinks<TMajorGetter>(this);
        }
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    internal partial class ALocationTargetCommon
    {
        ...
        public IEnumerable<IFormLinkGetter<TMajorGetter>> EnumerateFormLinks<TMajorGetter>(IALocationTargetGetter obj)
            where TMajorGetter : class, IMajorRecordGetter
        {
            yield break;
        }
