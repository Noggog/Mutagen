...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        ILoquiObjectSetter<AttackData>
    {
        ...
        {
            return AttackDataCommon.Instance.EnumerateFormLinks<TMajorGetter>(this);
        }
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    internal partial class AttackDataCommon
    {
        ...
        public IEnumerable<IFormLinkGetter<TMajorGetter>> EnumerateFormLinks<TMajorGetter>(IAttackDataGetter obj)
            where TMajorGetter : class, IMajorRecordGetter
        {
