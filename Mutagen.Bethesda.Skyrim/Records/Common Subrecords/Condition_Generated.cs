...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        ILoquiObjectSetter<Condition>
    {
        ...
        {
            return ConditionCommon.Instance.EnumerateFormLinks<TMajorGetter>(this);
        }
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    internal partial class ConditionCommon
    {
        ...
        public IEnumerable<IFormLinkGetter<TMajorGetter>> EnumerateFormLinks<TMajorGetter>(IConditionGetter obj)
            where TMajorGetter : class, IMajorRecordGetter
        {
