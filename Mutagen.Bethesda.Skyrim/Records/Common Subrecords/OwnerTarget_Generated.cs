...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IOwnerTarget
    {
        ...
        {
            return OwnerTargetCommon.Instance.EnumerateFormLinks<TMajorGetter>(this);
        }
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    internal partial class OwnerTargetCommon
    {
        ...
        public IEnumerable<IFormLinkGetter<TMajorGetter>> EnumerateFormLinks<TMajorGetter>(IOwnerTargetGetter obj)
            where TMajorGetter : class, IMajorRecordGetter
        {
            yield break;
        }
