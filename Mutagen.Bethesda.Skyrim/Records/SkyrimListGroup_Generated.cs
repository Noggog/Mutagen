...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        where T : class, ICellBlock, IBinaryItem
    {
        ...
        {
            return SkyrimListGroupCommon<T>.Instance.EnumerateFormLinks<TMajorGetter>(this);
        }
...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        where T : class, ICellBlockGetter, IBinaryItem
    {
        ...
        public IEnumerable<IFormLinkGetter<TMajorGetter>> EnumerateFormLinks<TMajorGetter>(ISkyrimListGroupGetter<T> obj)
