...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        ILoquiObjectSetter<LocationCoordinate>
    {
        ...
        {
            return LocationCoordinateCommon.Instance.EnumerateFormLinks<TMajorGetter>(this);
        }
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    internal partial class LocationCoordinateCommon
    {
        ...
        public IEnumerable<IFormLinkGetter<TMajorGetter>> EnumerateFormLinks<TMajorGetter>(ILocationCoordinateGetter obj)
            where TMajorGetter : class, IMajorRecordGetter
        {
