...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IPackageGetter
    {
        ...
        public Int32? Unknown4 => Payload.Unknown4Location.HasValue ? BinaryPrimitives.ReadInt32LittleEndian(HeaderTranslation.ExtractSubrecordMemory(_recordData, Payload.Unknown4Location.Value, _package.MetaData.Constants)) : default(Int32?);
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (type.TypeInt)
            {
                ...
                case RecordTypeInts.IDLB:
                {
                    _payload.Fields.Unknown4Location = (stream.Position - offset);
                    return (int)Package_FieldIndex.Unknown4;
                }
                case RecordTypeInts.IDLF:
                {
