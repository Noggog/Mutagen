...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IEquipTypeGetter
    {
        ...
        public Boolean? UseAllParents => Payload.UseAllParentsLocation.HasValue ? BinaryPrimitives.ReadUInt32LittleEndian(HeaderTranslation.ExtractSubrecordMemory(_recordData, Payload.UseAllParentsLocation.Value, _package.MetaData.Constants)) >= 1 : default(Boolean?);

        internal partial class EquipTypeRecordDataPayload
        {
            public IReadOnlyList<IFormLinkGetter<IEquipTypeGetter>>? SlotParents;
            public int? UseAllParentsLocation;
        }
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (type.TypeInt)
            {
                ...
                case RecordTypeInts.DATA:
                {
                    _payload.Fields.UseAllParentsLocation = (stream.Position - offset);
                    return (int)EquipType_FieldIndex.UseAllParents;
                }
                default:
