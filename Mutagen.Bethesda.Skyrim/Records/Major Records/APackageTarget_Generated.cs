...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        ILoquiObjectSetter<APackageTarget>
    {
        ...
        {
            return APackageTargetCommon.Instance.EnumerateFormLinks<TMajorGetter>(this);
        }
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    internal partial class APackageTargetCommon
    {
        ...
        public IEnumerable<IFormLinkGetter<TMajorGetter>> EnumerateFormLinks<TMajorGetter>(IAPackageTargetGetter obj)
            where TMajorGetter : class, IMajorRecordGetter
        {
            yield break;
        }
