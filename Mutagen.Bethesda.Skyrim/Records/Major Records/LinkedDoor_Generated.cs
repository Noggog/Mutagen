...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        ILoquiObjectSetter<LinkedDoor>
    {
        ...
        {
            return LinkedDoorCommon.Instance.EnumerateFormLinks<TMajorGetter>(this);
        }
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    internal partial class LinkedDoorCommon
    {
        ...
        public IEnumerable<IFormLinkGetter<TMajorGetter>> EnumerateFormLinks<TMajorGetter>(ILinkedDoorGetter obj)
            where TMajorGetter : class, IMajorRecordGetter
        {
