...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IAmmunitionGetter
    {
        ...
        IReadOnlyList<IFormLinkGetter<IKeywordCommonGetter>>? IKeywordedGetter.Keywords => this.Keywords;
        #endregion
        public Ammunition.DATADataType DATADataTypeState => Payload.DATADataTypeState;
        #region Projectile
        ...
        #endregion
        #region Flags
        private int _FlagsLocation => Payload.DATALocation!.Value.Min + 0x4;
        ...
        #endregion
        #region Damage
        private int _DamageLocation => Payload.DATALocation!.Value.Min + 0x8;
        ...
        #endregion
        #region Value
        private int _ValueLocation => Payload.DATALocation!.Value.Min + 0xC;
        ...
        #endregion
        #region Weight
        private int _WeightLocation => Payload.DATALocation!.Value.Min + 0x10;
        private bool _Weight_IsSet => Payload.DATALocation.HasValue && !DATADataTypeState.HasFlag(Ammunition.DATADataType.Break0) && _package.FormVersion!.FormVersion!.Value >= 44;
        ...
        #endregion
        public String? ShortName => Payload.ShortNameLocation.HasValue ? BinaryStringUtility.ProcessWholeToZString(HeaderTranslation.ExtractSubrecordMemory(_recordData, Payload.ShortNameLocation.Value, _package.MetaData.Constants), encoding: _package.MetaData.Encodings.NonTranslated) : default(string?);
        ...
        internal partial class AmmunitionRecordDataPayload
        {
            ...
            public Ammunition.DATADataType DATADataTypeState;
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (type.TypeInt)
            {
                ...
                case RecordTypeInts.DATA:
                {
                    ...
                    if (subLen <= 0x10)
                    {
                        _payload.Fields.DATADataTypeState |= Ammunition.DATADataType.Break0;
                    }
                    return (int)Ammunition_FieldIndex.Weight;
                }
                case RecordTypeInts.ONAM:
