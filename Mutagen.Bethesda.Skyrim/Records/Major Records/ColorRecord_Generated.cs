...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IColorRecordGetter
    {
        ...
        public Boolean Playable => Payload.PlayableLocation.HasValue ? BinaryPrimitives.ReadUInt32LittleEndian(HeaderTranslation.ExtractSubrecordMemory(_recordData, Payload.PlayableLocation.Value, _package.MetaData.Constants)) >= 1 : default(Boolean);

        internal partial class ColorRecordRecordDataPayload
        {
            public int? NameLocation;
            public int? ColorLocation;
            public int? PlayableLocation;
        }

        private LazyPayload<ColorRecordRecordDataPayload> _payload = null!;

        internal ColorRecordRecordDataPayload Payload => _payload.Value;

        protected override void InitPayload(Lazy<bool> init)
        {
            base.InitPayload(init);
            _payload = new LazyPayload<ColorRecordRecordDataPayload>(init, new ColorRecordRecordDataPayload());
        }
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (type.TypeInt)
            {
                ...
                case RecordTypeInts.FNAM:
                {
                    _payload.Fields.PlayableLocation = (stream.Position - offset);
                    return (int)ColorRecord_FieldIndex.Playable;
                }
                default:
