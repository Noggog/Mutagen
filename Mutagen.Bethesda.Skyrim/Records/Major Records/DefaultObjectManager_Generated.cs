...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IDefaultObjectManagerGetter
    {
        ...
        public IReadOnlyList<IDefaultObjectGetter>? Objects => Payload.Objects;

        internal partial class DefaultObjectManagerRecordDataPayload
        {
            public IReadOnlyList<IDefaultObjectGetter>? Objects;
        }
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (type.TypeInt)
            {
                case RecordTypeInts.DNAM:
                {
                    _payload.Fields.Objects = BinaryOverlayList.FactoryByStartIndexWithTrigger<IDefaultObjectGetter>(
                        stream: stream,
                        package: _package,
                        finalPos: finalPos,
                        itemLength: 8,
