...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        ILoquiObjectSetter<EdgeLink>
    {
        ...
        {
            return EdgeLinkCommon.Instance.EnumerateFormLinks<TMajorGetter>(this);
        }
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    internal partial class EdgeLinkCommon
    {
        ...
        public IEnumerable<IFormLinkGetter<TMajorGetter>> EnumerateFormLinks<TMajorGetter>(IEdgeLinkGetter obj)
            where TMajorGetter : class, IMajorRecordGetter
        {
