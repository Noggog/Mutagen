...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        ILoquiObjectSetter<DialogResponse>
    {
        ...
        {
            return DialogResponseCommon.Instance.EnumerateFormLinks<TMajorGetter>(this);
        }
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    internal partial class DialogResponseCommon
    {
        ...
        public IEnumerable<IFormLinkGetter<TMajorGetter>> EnumerateFormLinks<TMajorGetter>(IDialogResponseGetter obj)
            where TMajorGetter : class, IMajorRecordGetter
        {
