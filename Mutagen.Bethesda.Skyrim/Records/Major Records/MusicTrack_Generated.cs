...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IMusicTrackGetter
    {
        ...
        public AssetLinkGetter<SkyrimMusicAssetType>? TrackFilename => Payload.TrackFilenameLocation.HasValue ? new AssetLinkGetter<SkyrimMusicAssetType>(BinaryStringUtility.ProcessWholeToZString(HeaderTranslation.ExtractSubrecordMemory(_recordData, Payload.TrackFilenameLocation.Value, _package.MetaData.Constants), encoding: _package.MetaData.Encodings.NonTranslated)) : default(AssetLinkGetter<SkyrimMusicAssetType>?);
        public AssetLinkGetter<SkyrimMusicAssetType>? FinaleFilename => Payload.FinaleFilenameLocation.HasValue ? new AssetLinkGetter<SkyrimMusicAssetType>(BinaryStringUtility.ProcessWholeToZString(HeaderTranslation.ExtractSubrecordMemory(_recordData, Payload.FinaleFilenameLocation.Value, _package.MetaData.Constants), encoding: _package.MetaData.Encodings.NonTranslated)) : default(AssetLinkGetter<SkyrimMusicAssetType>?);
