...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IPortal
    {
        ...
        {
            return PortalCommon.Instance.EnumerateFormLinks<TMajorGetter>(this);
        }
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    internal partial class PortalCommon
    {
        ...
        public IEnumerable<IFormLinkGetter<TMajorGetter>> EnumerateFormLinks<TMajorGetter>(IPortalGetter obj)
            where TMajorGetter : class, IMajorRecordGetter
        {
