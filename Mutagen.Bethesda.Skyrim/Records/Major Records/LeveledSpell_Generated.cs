...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        ILeveledSpellGetter
    {
        ...
        public LeveledSpell.Flag Flags => EnumBinaryTranslation<LeveledSpell.Flag, MutagenFrame, MutagenWriter>.Instance.ParseRecord(Payload.FlagsLocation, _recordData, _package, 1);
        public IReadOnlyList<ILeveledSpellEntryGetter>? Entries => Payload.Entries;

        internal partial class LeveledSpellRecordDataPayload
        {
            public RangeInt32? ObjectBoundsLocation;
            public int? ChanceNoneLocation;
            public int? FlagsLocation;
            public IReadOnlyList<ILeveledSpellEntryGetter>? Entries;
        }

        private LazyPayload<LeveledSpellRecordDataPayload> _payload = null!;

        internal LeveledSpellRecordDataPayload Payload => _payload.Value;

        protected override void InitPayload(Lazy<bool> init)
        {
            base.InitPayload(init);
            _payload = new LazyPayload<LeveledSpellRecordDataPayload>(init, new LeveledSpellRecordDataPayload());
        }
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (type.TypeInt)
            {
                ...
                case RecordTypeInts.LLCT:
                {
                    _payload.Fields.Entries = BinaryOverlayList.FactoryByCountPerItem<ILeveledSpellEntryGetter>(
                        stream: stream,
                        package: _package,
                        countLength: 1,
