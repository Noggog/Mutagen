...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        INavmeshSet
    {
        ...
        {
            return NavmeshSetCommon.Instance.EnumerateFormLinks<TMajorGetter>(this);
        }
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    internal partial class NavmeshSetCommon
    {
        ...
        public IEnumerable<IFormLinkGetter<TMajorGetter>> EnumerateFormLinks<TMajorGetter>(INavmeshSetGetter obj)
            where TMajorGetter : class, IMajorRecordGetter
        {
