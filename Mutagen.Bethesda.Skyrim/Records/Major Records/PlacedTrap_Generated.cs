...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IPlacedTrapGetter
    {
        ...
        internal partial class PlacedTrapRecordDataPayload
        {
        }

        private LazyPayload<PlacedTrapRecordDataPayload> _payload = null!;

        internal PlacedTrapRecordDataPayload Payload => _payload.Value;

        protected override void InitPayload(Lazy<bool> init)
        {
            base.InitPayload(init);
            _payload = new LazyPayload<PlacedTrapRecordDataPayload>(init, new PlacedTrapRecordDataPayload());
        }
