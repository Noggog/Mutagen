...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IScrollGetter
    {
        ...
        #endregion
        #region HalfCostPerk
        private int _HalfCostPerkLocation => Payload.SPITLocation!.Value.Min + 0x20;
        private bool _HalfCostPerk_IsSet => Payload.SPITLocation.HasValue;
        ...
        internal partial class ScrollRecordDataPayload
        {
        ...
        private LazyPayload<ScrollRecordDataPayload> _payload = null!;

        internal ScrollRecordDataPayload Payload => _payload.Value;

        protected override void InitPayload(Lazy<bool> init)
        {
            base.InitPayload(init);
            _payload = new LazyPayload<ScrollRecordDataPayload>(init, new ScrollRecordDataPayload());
        }
