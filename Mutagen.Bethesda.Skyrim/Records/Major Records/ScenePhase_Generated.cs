...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IScenePhase
    {
        ...
        {
            return ScenePhaseCommon.Instance.EnumerateFormLinks<TMajorGetter>(this);
        }
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    internal partial class ScenePhaseCommon
    {
        ...
        public IEnumerable<IFormLinkGetter<TMajorGetter>> EnumerateFormLinks<TMajorGetter>(IScenePhaseGetter obj)
            where TMajorGetter : class, IMajorRecordGetter
        {
