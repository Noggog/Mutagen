...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IAnimatedObjectGetter
    {
        ...
        public String? UnloadEvent => Payload.UnloadEventLocation.HasValue ? BinaryStringUtility.ProcessWholeToZString(HeaderTranslation.ExtractSubrecordMemory(_recordData, Payload.UnloadEventLocation.Value, _package.MetaData.Constants), encoding: _package.MetaData.Encodings.NonTranslated) : default(string?);

        internal partial class AnimatedObjectRecordDataPayload
        {
            public IModelGetter? Model;
            public int? UnloadEventLocation;
        }
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (type.TypeInt)
            {
                ...
                case RecordTypeInts.BNAM:
                {
                    _payload.Fields.UnloadEventLocation = (stream.Position - offset);
                    return (int)AnimatedObject_FieldIndex.UnloadEvent;
                }
                default:
