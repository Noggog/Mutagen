...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        ILoquiObjectSetter<LocationRefTypeReference>
    {
        ...
        {
            return LocationRefTypeReferenceCommon.Instance.EnumerateFormLinks<TMajorGetter>(this);
        }
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    internal partial class LocationRefTypeReferenceCommon
    {
        ...
        public IEnumerable<IFormLinkGetter<TMajorGetter>> EnumerateFormLinks<TMajorGetter>(ILocationRefTypeReferenceGetter obj)
            where TMajorGetter : class, IMajorRecordGetter
        {
