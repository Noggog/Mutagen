...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IGlobalFloatGetter
    {
        ...
        internal partial class GlobalFloatRecordDataPayload
        {
            public int? DataLocation;
        }

        private LazyPayload<GlobalFloatRecordDataPayload> _payload = null!;

        internal GlobalFloatRecordDataPayload Payload => _payload.Value;

        protected override void InitPayload(Lazy<bool> init)
        {
            base.InitPayload(init);
            _payload = new LazyPayload<GlobalFloatRecordDataPayload>(init, new GlobalFloatRecordDataPayload());
        }
