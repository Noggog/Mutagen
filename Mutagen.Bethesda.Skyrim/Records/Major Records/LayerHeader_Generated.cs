...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        ILoquiObjectSetter<LayerHeader>
    {
        ...
        {
            return LayerHeaderCommon.Instance.EnumerateFormLinks<TMajorGetter>(this);
        }
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    internal partial class LayerHeaderCommon
    {
        ...
        public IEnumerable<IFormLinkGetter<TMajorGetter>> EnumerateFormLinks<TMajorGetter>(ILayerHeaderGetter obj)
            where TMajorGetter : class, IMajorRecordGetter
        {
