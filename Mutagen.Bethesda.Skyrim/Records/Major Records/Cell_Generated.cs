...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        ICellGetter
    {
        ...
        public ReadOnlyMemorySlice<Byte>? OcclusionData => Payload.OcclusionDataLocation.HasValue ? HeaderTranslation.ExtractSubrecordMemory(_recordData, Payload.OcclusionDataLocation.Value, _package.MetaData.Constants) : default(ReadOnlyMemorySlice<byte>?);
        ...
        public String? WaterNoiseTexture => Payload.WaterNoiseTextureLocation.HasValue ? BinaryStringUtility.ProcessWholeToZString(HeaderTranslation.ExtractSubrecordMemory(_recordData, Payload.WaterNoiseTextureLocation.Value, _package.MetaData.Constants), encoding: _package.MetaData.Encodings.NonTranslated) : default(string?);
        ...
        internal partial class CellRecordDataPayload
        {
            ...
            public int? OcclusionDataLocation;
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (type.TypeInt)
            {
                ...
                case RecordTypeInts.TVDT:
                {
                    _payload.Fields.OcclusionDataLocation = (stream.Position - offset);
                    return (int)Cell_FieldIndex.OcclusionData;
                }
                case RecordTypeInts.MHDT:
                {
