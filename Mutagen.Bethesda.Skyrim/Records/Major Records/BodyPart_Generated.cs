...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        ILoquiObjectSetter<BodyPart>
    {
        ...
        {
            return BodyPartCommon.Instance.EnumerateFormLinks<TMajorGetter>(this);
        }
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    internal partial class BodyPartCommon
    {
        ...
        public IEnumerable<IFormLinkGetter<TMajorGetter>> EnumerateFormLinks<TMajorGetter>(IBodyPartGetter obj)
            where TMajorGetter : class, IMajorRecordGetter
        {
