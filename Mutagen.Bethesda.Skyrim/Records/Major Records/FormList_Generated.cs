...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IFormListGetter
    {
        ...
        public IReadOnlyList<IFormLinkGetter<ISkyrimMajorRecordGetter>> Items => Payload.Items ?? [];

        internal partial class FormListRecordDataPayload
        {
            public IReadOnlyList<IFormLinkGetter<ISkyrimMajorRecordGetter>> Items = [];
        }
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (type.TypeInt)
            {
                case RecordTypeInts.LNAM:
                {
                    _payload.Fields.Items = BinaryOverlayList.FactoryByArray<IFormLinkGetter<ISkyrimMajorRecordGetter>>(
