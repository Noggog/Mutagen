...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        ILoquiObjectSetter<FurnitureMarker>
    {
        ...
        {
            return FurnitureMarkerCommon.Instance.EnumerateFormLinks<TMajorGetter>(this);
        }
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    internal partial class FurnitureMarkerCommon
    {
        ...
        public IEnumerable<IFormLinkGetter<TMajorGetter>> EnumerateFormLinks<TMajorGetter>(IFurnitureMarkerGetter obj)
            where TMajorGetter : class, IMajorRecordGetter
        {
