...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IGlobalShortGetter
    {
        ...
        private LazyPayload<GlobalShortRecordDataPayload> _payload = null!;

        internal GlobalShortRecordDataPayload Payload => _payload.Value;

        protected override void InitPayload(Lazy<bool> init)
        {
            base.InitPayload(init);
            _payload = new LazyPayload<GlobalShortRecordDataPayload>(init, new GlobalShortRecordDataPayload());
        }
