...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IDebrisGetter
    {
        ...
        public IReadOnlyList<IDebrisModelGetter> Models => Payload.Models ?? [];

        internal partial class DebrisRecordDataPayload
        {
            public IReadOnlyList<IDebrisModelGetter> Models = [];
        }

        private LazyPayload<DebrisRecordDataPayload> _payload = null!;

        internal DebrisRecordDataPayload Payload => _payload.Value;

        protected override void InitPayload(Lazy<bool> init)
        {
            base.InitPayload(init);
            _payload = new LazyPayload<DebrisRecordDataPayload>(init, new DebrisRecordDataPayload());
        }
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (type.TypeInt)
            {
                case RecordTypeInts.DATA:
                {
                    _payload.Fields.Models = this.ParseRepeatedTypelessSubrecord<IDebrisModelGetter>(
                        stream: stream,
                        translationParams: translationParams,
