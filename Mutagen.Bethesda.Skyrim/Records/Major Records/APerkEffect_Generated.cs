...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        ILoquiObjectSetter<APerkEffect>
    {
        ...
        {
            return APerkEffectCommon.Instance.EnumerateFormLinks<TMajorGetter>(this);
        }
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    internal partial class APerkEffectCommon
    {
        ...
        public IEnumerable<IFormLinkGetter<TMajorGetter>> EnumerateFormLinks<TMajorGetter>(IAPerkEffectGetter obj)
            where TMajorGetter : class, IMajorRecordGetter
        {
