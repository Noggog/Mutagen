...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IEyesGetter
    {
        ...
        #endregion
        #endregion
        public AssetLinkGetter<SkyrimTextureAssetType> Icon => Payload.IconLocation.HasValue ? new AssetLinkGetter<SkyrimTextureAssetType>(BinaryStringUtility.ProcessWholeToZString(HeaderTranslation.ExtractSubrecordMemory(_recordData, Payload.IconLocation.Value, _package.MetaData.Constants), encoding: _package.MetaData.Encodings.NonTranslated)) : AssetLinkGetter<SkyrimTextureAssetType>.Null;
        public Eyes.Flag Flags => EnumBinaryTranslation<Eyes.Flag, MutagenFrame, MutagenWriter>.Instance.ParseRecord(Payload.FlagsLocation, _recordData, _package, 1);

        internal partial class EyesRecordDataPayload
        {
        ...
        private LazyPayload<EyesRecordDataPayload> _payload = null!;

        internal EyesRecordDataPayload Payload => _payload.Value;

        protected override void InitPayload(Lazy<bool> init)
        {
            base.InitPayload(init);
            _payload = new LazyPayload<EyesRecordDataPayload>(init, new EyesRecordDataPayload());
        }
