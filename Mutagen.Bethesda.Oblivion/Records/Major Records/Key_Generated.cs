...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        IKeyGetter
    {
        ...
        public IKeyDataGetter? Data => Payload.DataLocation.HasValue ? KeyDataBinaryOverlay.KeyDataFactory(_recordData.Slice(Payload.DataLocation!.Value.Min), _package) : default;
