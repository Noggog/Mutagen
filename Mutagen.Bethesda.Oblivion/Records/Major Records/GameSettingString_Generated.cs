...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        IGameSettingStringGetter
    {
        ...
        public String? Data => Payload.DataLocation.HasValue ? BinaryStringUtility.ProcessWholeToZString(HeaderTranslation.ExtractSubrecordMemory(_recordData, Payload.DataLocation.Value, _package.MetaData.Constants), encoding: _package.MetaData.Encodings.NonTranslated) : default(string?);

        internal partial class GameSettingStringRecordDataPayload
        {
            public int? DataLocation;
        }

        private LazyPayload<GameSettingStringRecordDataPayload> _payload = null!;

        internal GameSettingStringRecordDataPayload Payload => _payload.Value;

        protected override void InitPayload(Lazy<bool> init)
        {
            base.InitPayload(init);
            _payload = new LazyPayload<GameSettingStringRecordDataPayload>(init, new GameSettingStringRecordDataPayload());
        }
