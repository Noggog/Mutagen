...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        IGrassGetter
    {
        ...
        public IGrassDataGetter? Data => Payload.DataLocation.HasValue ? GrassDataBinaryOverlay.GrassDataFactory(_recordData.Slice(Payload.DataLocation!.Value.Min), _package) : default;
