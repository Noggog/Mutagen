...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        IEyeGetter
    {
        ...
        public Eye.Flag? Flags => EnumBinaryTranslation<Eye.Flag, MutagenFrame, MutagenWriter>.Instance.ParseRecordNullable(Payload.FlagsLocation, _recordData, _package, 1);

        internal partial class EyeRecordDataPayload
        {
        ...
        private LazyPayload<EyeRecordDataPayload> _payload = null!;

        internal EyeRecordDataPayload Payload => _payload.Value;

        protected override void InitPayload(Lazy<bool> init)
        {
            base.InitPayload(init);
            _payload = new LazyPayload<EyeRecordDataPayload>(init, new EyeRecordDataPayload());
        }
