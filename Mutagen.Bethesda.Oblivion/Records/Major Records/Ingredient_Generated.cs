...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        IIngredientGetter
    {
        ...
        public IIngredientDataGetter? Data => Payload.DataLocation.HasValue ? IngredientDataBinaryOverlay.IngredientDataFactory(_recordData.Slice(Payload.DataLocation!.Value.Min), _package) : default;
        public IReadOnlyList<IEffectGetter> Effects => Payload.Effects ?? [];

        internal partial class IngredientRecordDataPayload
        {
        ...
        private LazyPayload<IngredientRecordDataPayload> _payload = null!;

        internal IngredientRecordDataPayload Payload => _payload.Value;

        protected override void InitPayload(Lazy<bool> init)
        {
            base.InitPayload(init);
            _payload = new LazyPayload<IngredientRecordDataPayload>(init, new IngredientRecordDataPayload());
        }
