...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        IHairGetter
    {
        ...
        public Hair.HairFlag? Flags => EnumBinaryTranslation<Hair.HairFlag, MutagenFrame, MutagenWriter>.Instance.ParseRecordNullable(Payload.FlagsLocation, _recordData, _package, 1);

        internal partial class HairRecordDataPayload
        {
        ...
        private LazyPayload<HairRecordDataPayload> _payload = null!;

        internal HairRecordDataPayload Payload => _payload.Value;

        protected override void InitPayload(Lazy<bool> init)
        {
            base.InitPayload(init);
            _payload = new LazyPayload<HairRecordDataPayload>(init, new HairRecordDataPayload());
        }
