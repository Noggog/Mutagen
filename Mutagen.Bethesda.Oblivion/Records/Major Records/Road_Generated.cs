...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        IRoadGetter
    {
        ...
        internal partial class RoadRecordDataPayload
        {
        }

        private LazyPayload<RoadRecordDataPayload> _payload = null!;

        internal RoadRecordDataPayload Payload => _payload.Value;

        protected override void InitPayload(Lazy<bool> init)
        {
            base.InitPayload(init);
            _payload = new LazyPayload<RoadRecordDataPayload>(init, new RoadRecordDataPayload());
        }
