...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        IFloraGetter
    {
        ...
        public IFormLinkNullableGetter<IIngredientGetter> Ingredient => FormLinkBinaryTranslation.Instance.NullableRecordOverlayFactory<IIngredientGetter>(_package, _recordData, Payload.IngredientLocation);
        public ISeasonalIngredientProductionGetter? SeasonalIngredientProduction => Payload.SeasonalIngredientProductionLocation.HasValue ? SeasonalIngredientProductionBinaryOverlay.SeasonalIngredientProductionFactory(_recordData.Slice(Payload.SeasonalIngredientProductionLocation!.Value.Min), _package) : default;
        ...
        internal partial class FloraRecordDataPayload
        {
            ...
            public RangeInt32? SeasonalIngredientProductionLocation;
        }
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (type.TypeInt)
            {
                ...
                case RecordTypeInts.PFPC:
                {
                    _payload.Fields.SeasonalIngredientProductionLocation = new RangeInt32((stream.Position - offset), finalPos - offset);
                    return (int)Flora_FieldIndex.SeasonalIngredientProduction;
                }
                default:
