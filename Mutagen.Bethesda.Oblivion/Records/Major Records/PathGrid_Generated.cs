...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        IPathGridGetter
    {
        ...
        partial void PointToPointConnectionsCustomParse(
            ...
            PreviousParse lastParsed);
        #endregion
        public IReadOnlyList<IInterCellPointGetter>? InterCellConnections => Payload.InterCellConnections;
        public IReadOnlyList<IPointToReferenceMappingGetter> PointToReferenceMappings => Payload.PointToReferenceMappings ?? [];

        internal partial class PathGridRecordDataPayload
        {
            public IReadOnlyList<IInterCellPointGetter>? InterCellConnections;
            public IReadOnlyList<IPointToReferenceMappingGetter> PointToReferenceMappings = [];
        }

        private LazyPayload<PathGridRecordDataPayload> _payload = null!;

        internal PathGridRecordDataPayload Payload => _payload.Value;

        protected override void InitPayload(Lazy<bool> init)
        {
            base.InitPayload(init);
            _payload = new LazyPayload<PathGridRecordDataPayload>(init, new PathGridRecordDataPayload());
        }
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (type.TypeInt)
            {
                ...
                case RecordTypeInts.PGRI:
                {
                    _payload.Fields.InterCellConnections = BinaryOverlayList.FactoryByStartIndexWithTrigger<IInterCellPointGetter>(
                        stream: stream,
                        package: _package,
                        finalPos: finalPos,
                        itemLength: 16,
                ...
                case RecordTypeInts.PGRL:
                {
                    _payload.Fields.PointToReferenceMappings = BinaryOverlayList.FactoryByArray<IPointToReferenceMappingGetter>(
