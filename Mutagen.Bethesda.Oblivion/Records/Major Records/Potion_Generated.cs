...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        IPotionGetter
    {
        ...
        public IPotionDataGetter? Data => Payload.DataLocation.HasValue ? PotionDataBinaryOverlay.PotionDataFactory(_recordData.Slice(Payload.DataLocation!.Value.Min), _package) : default;
        public IReadOnlyList<IEffectGetter> Effects => Payload.Effects ?? [];

        internal partial class PotionRecordDataPayload
        {
        ...
        private LazyPayload<PotionRecordDataPayload> _payload = null!;

        internal PotionRecordDataPayload Payload => _payload.Value;

        protected override void InitPayload(Lazy<bool> init)
        {
            base.InitPayload(init);
            _payload = new LazyPayload<PotionRecordDataPayload>(init, new PotionRecordDataPayload());
        }
