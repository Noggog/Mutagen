...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        IScriptGetter
    {
        ...
        #region Fields
        private IScriptFieldsGetter? _Fields => Payload.Fields;
        public IScriptFieldsGetter Fields => _Fields ?? new ScriptFields();
        #endregion

        internal partial class ScriptRecordDataPayload
        {
            public IScriptFieldsGetter? Fields;
        }

        private LazyPayload<ScriptRecordDataPayload> _payload = null!;

        internal ScriptRecordDataPayload Payload => _payload.Value;

        protected override void InitPayload(Lazy<bool> init)
        {
            base.InitPayload(init);
            _payload = new LazyPayload<ScriptRecordDataPayload>(init, new ScriptRecordDataPayload());
        }
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (type.TypeInt)
            {
                ...
                case RecordTypeInts.SCHR:
                {
                    _payload.Fields.Fields = ScriptFieldsBinaryOverlay.ScriptFieldsFactory(
                        stream: stream,
                        package: _package,
