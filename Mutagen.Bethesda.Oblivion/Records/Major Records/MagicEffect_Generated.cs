...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        IMagicEffectGetter
    {
        ...
        public IMagicEffectDataGetter? Data => Payload.DataLocation.HasValue ? MagicEffectDataBinaryOverlay.MagicEffectDataFactory(_recordData.Slice(Payload.DataLocation!.Value.Min), _package) : default;
        public IReadOnlyList<IEDIDLinkGetter<IMagicEffectGetter>>? CounterEffects => Payload.CounterEffects;
        ...
        internal partial class MagicEffectRecordDataPayload
        {
            ...
            public IReadOnlyList<IEDIDLinkGetter<IMagicEffectGetter>>? CounterEffects;
        }
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (type.TypeInt)
            {
                ...
                case RecordTypeInts.ESCE:
                {
                    _payload.Fields.CounterEffects = BinaryOverlayList.FactoryByStartIndexWithTrigger<IEDIDLinkGetter<IMagicEffectGetter>>(
                        stream: stream,
                        package: _package,
                        finalPos: finalPos,
                        itemLength: 4,
