...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        ISigilStoneGetter
    {
        ...
        public ISigilStoneDataGetter? Data => Payload.DataLocation.HasValue ? SigilStoneDataBinaryOverlay.SigilStoneDataFactory(_recordData.Slice(Payload.DataLocation!.Value.Min), _package) : default;

        internal partial class SigilStoneRecordDataPayload
        {
        ...
        private LazyPayload<SigilStoneRecordDataPayload> _payload = null!;

        internal SigilStoneRecordDataPayload Payload => _payload.Value;

        protected override void InitPayload(Lazy<bool> init)
        {
            base.InitPayload(init);
            _payload = new LazyPayload<SigilStoneRecordDataPayload>(init, new SigilStoneRecordDataPayload());
        }
