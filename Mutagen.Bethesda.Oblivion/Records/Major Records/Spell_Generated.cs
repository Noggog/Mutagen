...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        ISpellGetter
    {
        ...
        #endregion
        #endregion
        public ISpellDataGetter? Data => Payload.DataLocation.HasValue ? SpellDataBinaryOverlay.SpellDataFactory(_recordData.Slice(Payload.DataLocation!.Value.Min), _package) : default;
