...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        IClassGetter
    {
        ...
        public IClassDataGetter? Data => Payload.DataLocation.HasValue ? ClassDataBinaryOverlay.ClassDataFactory(_recordData.Slice(Payload.DataLocation!.Value.Min), _package) : default;
