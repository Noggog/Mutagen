...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        IGlobalIntGetter
    {
        ...
        private LazyPayload<GlobalIntRecordDataPayload> _payload = null!;

        internal GlobalIntRecordDataPayload Payload => _payload.Value;

        protected override void InitPayload(Lazy<bool> init)
        {
            base.InitPayload(init);
            _payload = new LazyPayload<GlobalIntRecordDataPayload>(init, new GlobalIntRecordDataPayload());
        }
