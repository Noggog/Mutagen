...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        IMiscellaneousGetter
    {
        ...
        public IMiscellaneousDataGetter? Data => Payload.DataLocation.HasValue ? MiscellaneousDataBinaryOverlay.MiscellaneousDataFactory(_recordData.Slice(Payload.DataLocation!.Value.Min), _package) : default;

        internal partial class MiscellaneousRecordDataPayload
        {
        ...
        private LazyPayload<MiscellaneousRecordDataPayload> _payload = null!;

        internal MiscellaneousRecordDataPayload Payload => _payload.Value;

        protected override void InitPayload(Lazy<bool> init)
        {
            base.InitPayload(init);
            _payload = new LazyPayload<MiscellaneousRecordDataPayload>(init, new MiscellaneousRecordDataPayload());
        }
