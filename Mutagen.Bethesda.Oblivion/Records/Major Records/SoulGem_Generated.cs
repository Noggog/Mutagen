...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        ISoulGemGetter
    {
        ...
        public ISoulGemDataGetter? Data => Payload.DataLocation.HasValue ? SoulGemDataBinaryOverlay.SoulGemDataFactory(_recordData.Slice(Payload.DataLocation!.Value.Min), _package) : default;
        public SoulLevel? ContainedSoul => EnumBinaryTranslation<SoulLevel, MutagenFrame, MutagenWriter>.Instance.ParseRecordNullable(Payload.ContainedSoulLocation, _recordData, _package, 1);
        public SoulLevel? MaximumCapacity => EnumBinaryTranslation<SoulLevel, MutagenFrame, MutagenWriter>.Instance.ParseRecordNullable(Payload.MaximumCapacityLocation, _recordData, _package, 1);
