...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        ILightGetter
    {
        ...
        public ILightDataGetter? Data => Payload.DataLocation.HasValue ? LightDataBinaryOverlay.LightDataFactory(_recordData.Slice(Payload.DataLocation!.Value.Min), _package) : default;
        public Single? Fade => Payload.FadeLocation.HasValue ? HeaderTranslation.ExtractSubrecordMemory(_recordData, Payload.FadeLocation.Value, _package.MetaData.Constants).Float() : default(Single?);
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (type.TypeInt)
            {
                ...
                case RecordTypeInts.FNAM:
                {
                    _payload.Fields.FadeLocation = (stream.Position - offset);
                    return (int)Light_FieldIndex.Fade;
                }
                case RecordTypeInts.SNAM:
                {
