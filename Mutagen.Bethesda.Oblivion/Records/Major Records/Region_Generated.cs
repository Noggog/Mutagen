...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        IRegionGetter
    {
        ...
        public IReadOnlyList<IRegionAreaGetter> Areas => Payload.Areas ?? [];
        ...
        internal partial class RegionRecordDataPayload
        {
            ...
            public IReadOnlyList<IRegionAreaGetter> Areas = [];
        }
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (type.TypeInt)
            {
                ...
                case RecordTypeInts.RPLD:
                {
                    _payload.Fields.Areas = this.ParseRepeatedTypelessSubrecord<IRegionAreaGetter>(
                        stream: stream,
                        translationParams: translationParams,
