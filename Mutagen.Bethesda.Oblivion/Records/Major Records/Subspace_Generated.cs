...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        ISubspaceGetter
    {
        ...
        public P3Float? Point => Payload.PointLocation.HasValue ? P3FloatBinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Read(HeaderTranslation.ExtractSubrecordMemory(_recordData, Payload.PointLocation.Value, _package.MetaData.Constants)) : default(P3Float?);

        internal partial class SubspaceRecordDataPayload
        {
            public int? PointLocation;
        }

        private LazyPayload<SubspaceRecordDataPayload> _payload = null!;

        internal SubspaceRecordDataPayload Payload => _payload.Value;

        protected override void InitPayload(Lazy<bool> init)
        {
            base.InitPayload(init);
            _payload = new LazyPayload<SubspaceRecordDataPayload>(init, new SubspaceRecordDataPayload());
        }
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (type.TypeInt)
            {
                case RecordTypeInts.DNAM:
                {
                    _payload.Fields.PointLocation = (stream.Position - offset);
                    return (int)Subspace_FieldIndex.Point;
                }
                default:
