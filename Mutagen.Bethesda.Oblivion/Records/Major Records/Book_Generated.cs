...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        IBookGetter
    {
        ...
        public IBookDataGetter? Data => Payload.DataLocation.HasValue ? BookDataBinaryOverlay.BookDataFactory(_recordData.Slice(Payload.DataLocation!.Value.Min), _package) : default;
