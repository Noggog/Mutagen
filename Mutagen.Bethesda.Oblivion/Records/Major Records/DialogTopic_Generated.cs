...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        IDialogTopicGetter
    {
        ...
        public IReadOnlyList<IFormLinkGetter<IQuestGetter>> Quests => Payload.Quests ?? [];
        #region Name
        ...
        #endregion
        #endregion
        public DialogType? DialogType => EnumBinaryTranslation<DialogType, MutagenFrame, MutagenWriter>.Instance.ParseRecordNullable(Payload.DialogTypeLocation, _recordData, _package, 1);

        internal partial class DialogTopicRecordDataPayload
        {
            public IReadOnlyList<IFormLinkGetter<IQuestGetter>> Quests = [];
            public int? NameLocation;
            public int? DialogTypeLocation;
        }
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (type.TypeInt)
            {
                case RecordTypeInts.QSTI:
                {
                    _payload.Fields.Quests = BinaryOverlayList.FactoryByArray<IFormLinkGetter<IQuestGetter>>(
                ...
                case RecordTypeInts.DATA:
                {
                    _payload.Fields.DialogTypeLocation = (stream.Position - offset);
                    return (int)DialogTopic_FieldIndex.DialogType;
                }
                default:
