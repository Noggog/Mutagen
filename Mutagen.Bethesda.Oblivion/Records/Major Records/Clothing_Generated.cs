...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        IClothingGetter
    {
        ...
        public IClothingDataGetter? Data => Payload.DataLocation.HasValue ? ClothingDataBinaryOverlay.ClothingDataFactory(_recordData.Slice(Payload.DataLocation!.Value.Min), _package) : default;

        internal partial class ClothingRecordDataPayload
        {
        ...
        private LazyPayload<ClothingRecordDataPayload> _payload = null!;

        internal ClothingRecordDataPayload Payload => _payload.Value;

        protected override void InitPayload(Lazy<bool> init)
        {
            base.InitPayload(init);
            _payload = new LazyPayload<ClothingRecordDataPayload>(init, new ClothingRecordDataPayload());
        }
