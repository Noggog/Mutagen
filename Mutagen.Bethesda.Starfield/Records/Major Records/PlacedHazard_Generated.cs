...
namespace Mutagen.Bethesda.Starfield
{
        ...
        IPlacedHazardGetter
    {
        ...
        internal partial class PlacedHazardRecordDataPayload
        {
        }

        private LazyPayload<PlacedHazardRecordDataPayload> _payload = null!;

        internal PlacedHazardRecordDataPayload Payload => _payload.Value;

        protected override void InitPayload(Lazy<bool> init)
        {
            base.InitPayload(init);
            _payload = new LazyPayload<PlacedHazardRecordDataPayload>(init, new PlacedHazardRecordDataPayload());
        }
