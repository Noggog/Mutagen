...
namespace Mutagen.Bethesda.Starfield
{
        ...
        IUnknownObjectModificationGetter
    {
        ...
        internal partial class UnknownObjectModificationRecordDataPayload
        {
        }

        private LazyPayload<UnknownObjectModificationRecordDataPayload> _payload = null!;

        internal UnknownObjectModificationRecordDataPayload Payload => _payload.Value;

        protected override void InitPayload(Lazy<bool> init)
        {
            base.InitPayload(init);
            _payload = new LazyPayload<UnknownObjectModificationRecordDataPayload>(init, new UnknownObjectModificationRecordDataPayload());
        }
