...
namespace Mutagen.Bethesda.Starfield
{
        ...
        IMoveableStaticGetter
    {
        ...
        public ITransformsGetter? Transforms2 => Payload.Transforms2Location.HasValue ? TransformsBinaryOverlay.TransformsFactory(_recordData.Slice(Payload.Transforms2Location!.Value.Min), _package) : default;
        #region Name
        ...
        public Byte DATA => Payload.DATALocation.HasValue ? HeaderTranslation.ExtractSubrecordMemory(_recordData, Payload.DATALocation.Value, _package.MetaData.Constants)[0] : default(Byte);
        public ISoundReferenceGetter? MSLS => Payload.MSLS;
        public Single? MSMO => Payload.MSMOLocation.HasValue ? HeaderTranslation.ExtractSubrecordMemory(_recordData, Payload.MSMOLocation.Value, _package.MetaData.Constants).Float() : default(Single?);

        internal partial class MoveableStaticRecordDataPayload
        {
            ...
            public RangeInt32? Transforms2Location;
            ...
            public ISoundReferenceGetter? MSLS;
            public int? MSMOLocation;
        }

        private LazyPayload<MoveableStaticRecordDataPayload> _payload = null!;

        internal MoveableStaticRecordDataPayload Payload => _payload.Value;

        protected override void InitPayload(Lazy<bool> init)
        {
            base.InitPayload(init);
            _payload = new LazyPayload<MoveableStaticRecordDataPayload>(init, new MoveableStaticRecordDataPayload());
        }
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (type.TypeInt)
            {
                ...
                case RecordTypeInts.PTT2:
                {
                    ...
                    {
                        _payload.Fields.Transforms2Location = new RangeInt32((stream.Position - offset), finalPos - offset);
                ...
                case RecordTypeInts.MSLS:
                {
                    ...
                    _payload.Fields.MSLS = SoundReferenceBinaryOverlay.SoundReferenceFactory(
                        stream: stream,
                        package: _package,
                        translationParams: translationParams.DoNotShortCircuit());
                    return (int)MoveableStatic_FieldIndex.MSLS;
                ...
                case RecordTypeInts.MSMO:
                {
                    _payload.Fields.MSMOLocation = (stream.Position - offset);
                    return (int)MoveableStatic_FieldIndex.MSMO;
                }
                case RecordTypeInts.XXXX:
                {
