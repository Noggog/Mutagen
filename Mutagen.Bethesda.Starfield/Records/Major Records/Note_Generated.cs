...
namespace Mutagen.Bethesda.Starfield
{
        ...
        INoteGetter
    {
        ...
        private LazyPayload<NoteRecordDataPayload> _payload = null!;

        internal NoteRecordDataPayload Payload => _payload.Value;

        protected override void InitPayload(Lazy<bool> init)
        {
            base.InitPayload(init);
            _payload = new LazyPayload<NoteRecordDataPayload>(init, new NoteRecordDataPayload());
        }
