...
namespace Mutagen.Bethesda.Starfield
{
        ...
        IForceDataGetter
    {
        ...
        internal partial class ForceDataRecordDataPayload
        {
            public int? REFLLocation;
        }

        private LazyPayload<ForceDataRecordDataPayload> _payload = null!;

        internal ForceDataRecordDataPayload Payload => _payload.Value;

        protected override void InitPayload(Lazy<bool> init)
        {
            base.InitPayload(init);
            _payload = new LazyPayload<ForceDataRecordDataPayload>(init, new ForceDataRecordDataPayload());
        }
