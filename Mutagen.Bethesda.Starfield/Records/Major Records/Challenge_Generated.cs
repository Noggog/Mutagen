...
namespace Mutagen.Bethesda.Starfield
{
        ...
        IChallengeGetter
    {
        ...
        internal partial class ChallengeRecordDataPayload
        {
            public IReadOnlyList<IAComponentGetter> Components = [];
        }

        private LazyPayload<ChallengeRecordDataPayload> _payload = null!;

        internal ChallengeRecordDataPayload Payload => _payload.Value;

        protected override void InitPayload(Lazy<bool> init)
        {
            base.InitPayload(init);
            _payload = new LazyPayload<ChallengeRecordDataPayload>(init, new ChallengeRecordDataPayload());
        }
