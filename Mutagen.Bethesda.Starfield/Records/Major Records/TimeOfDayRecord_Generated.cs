...
namespace Mutagen.Bethesda.Starfield
{
        ...
        ITimeOfDayRecordGetter
    {
        ...
        internal partial class TimeOfDayRecordRecordDataPayload
        {
            public IReadOnlyList<IAComponentGetter> Components = [];
            public int? REFLLocation;
        }

        private LazyPayload<TimeOfDayRecordRecordDataPayload> _payload = null!;

        internal TimeOfDayRecordRecordDataPayload Payload => _payload.Value;

        protected override void InitPayload(Lazy<bool> init)
        {
            base.InitPayload(init);
            _payload = new LazyPayload<TimeOfDayRecordRecordDataPayload>(init, new TimeOfDayRecordRecordDataPayload());
        }
