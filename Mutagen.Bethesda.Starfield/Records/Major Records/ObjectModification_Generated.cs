...
namespace Mutagen.Bethesda.Starfield
{
        ...
        IObjectModificationGetter
    {
        ...
        internal partial class ObjectModificationRecordDataPayload
        {
        }

        private LazyPayload<ObjectModificationRecordDataPayload> _payload = null!;

        internal ObjectModificationRecordDataPayload Payload => _payload.Value;

        protected override void InitPayload(Lazy<bool> init)
        {
            base.InitPayload(init);
            _payload = new LazyPayload<ObjectModificationRecordDataPayload>(init, new ObjectModificationRecordDataPayload());
        }
