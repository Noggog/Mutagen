        ...
        ITimelineSceneActionGetter
    {
        ...
        public Int32? TNAM
        {
            get
            {
                ...
                return _TNAMLocation.HasValue ? BinaryPrimitives.ReadInt32LittleEndian(HeaderTranslation.ExtractSubrecordMemory(_data, _TNAMLocation.Value, _package.MetaData.Constants)) : default(Int32?);
            }
        }
        #endregion
        #region SNAM
        ...
        public Int32? SNAM
        {
            ...
            {
                var _data = _recordData; // Trigger lazy initialization if needed
                return _SNAMLocation.HasValue ? BinaryPrimitives.ReadInt32LittleEndian(HeaderTranslation.ExtractSubrecordMemory(_data, _SNAMLocation.Value, _package.MetaData.Constants)) : default(Int32?);
            }
        }
        #endregion
        #region UNAM
        ...
        public Int32? UNAM
        {
            ...
            {
                var _data = _recordData; // Trigger lazy initialization if needed
                return _UNAMLocation.HasValue ? BinaryPrimitives.ReadInt32LittleEndian(HeaderTranslation.ExtractSubrecordMemory(_data, _UNAMLocation.Value, _package.MetaData.Constants)) : default(Int32?);
            }
        }
        #endregion
        #region LNAM
        ...
        public Int32? LNAM
        {
            ...
            {
                var _data = _recordData; // Trigger lazy initialization if needed
                return _LNAMLocation.HasValue ? BinaryPrimitives.ReadInt32LittleEndian(HeaderTranslation.ExtractSubrecordMemory(_data, _LNAMLocation.Value, _package.MetaData.Constants)) : default(Int32?);
            }
        }
        #endregion
        #region CNAM
        ...
        public Int32? CNAM
        {
            ...
            {
                var _data = _recordData; // Trigger lazy initialization if needed
                return _CNAMLocation.HasValue ? BinaryPrimitives.ReadInt32LittleEndian(HeaderTranslation.ExtractSubrecordMemory(_data, _CNAMLocation.Value, _package.MetaData.Constants)) : default(Int32?);
            }
        }
        #endregion
