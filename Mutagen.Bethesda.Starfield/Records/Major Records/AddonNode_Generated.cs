...
namespace Mutagen.Bethesda.Starfield
{
        ...
        IAddonNodeGetter
    {
        ...
        public UInt32 NodeIndex => Payload.NodeIndexLocation.HasValue ? BinaryPrimitives.ReadUInt32LittleEndian(HeaderTranslation.ExtractSubrecordMemory(_recordData, Payload.NodeIndexLocation.Value, _package.MetaData.Constants)) : default(UInt32);
        public IFormLinkNullableGetter<ILightGetter> Light => FormLinkBinaryTranslation.Instance.NullableRecordOverlayFactory<ILightGetter>(_package, _recordData, Payload.LightLocation);
        public ReadOnlyMemorySlice<Byte>? Reflection => Payload.ReflectionLocation.HasValue ? HeaderTranslation.ExtractSubrecordMemory(_recordData, Payload.ReflectionLocation.Value, _package.MetaData.Constants) : default(ReadOnlyMemorySlice<byte>?);
        #region MasterParticleSystemCap
        private int _MasterParticleSystemCapLocation => Payload.DNAMLocation!.Value.Min;
        private bool _MasterParticleSystemCap_IsSet => Payload.DNAMLocation.HasValue;
        ...
        #endregion
        #region Flags
        private int _FlagsLocation => Payload.DNAMLocation!.Value.Min + 0x2;
        ...
        internal partial class AddonNodeRecordDataPayload
        {
            ...
            public int? NodeIndexLocation;
            public int? LightLocation;
            public int? ReflectionLocation;
            public RangeInt32? DNAMLocation;
        }

        private LazyPayload<AddonNodeRecordDataPayload> _payload = null!;

        internal AddonNodeRecordDataPayload Payload => _payload.Value;

        protected override void InitPayload(Lazy<bool> init)
        {
            base.InitPayload(init);
            _payload = new LazyPayload<AddonNodeRecordDataPayload>(init, new AddonNodeRecordDataPayload());
        }
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (type.TypeInt)
            {
                ...
                case RecordTypeInts.DATA:
                {
                    _payload.Fields.NodeIndexLocation = (stream.Position - offset);
                    return (int)AddonNode_FieldIndex.NodeIndex;
                }
                case RecordTypeInts.LNAM:
                {
                    _payload.Fields.LightLocation = (stream.Position - offset);
                    return (int)AddonNode_FieldIndex.Light;
                }
                case RecordTypeInts.PSDF:
                {
                    _payload.Fields.ReflectionLocation = (stream.Position - offset);
                    return (int)AddonNode_FieldIndex.Reflection;
                }
                case RecordTypeInts.DNAM:
                {
