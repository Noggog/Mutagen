...
namespace Mutagen.Bethesda.Starfield
{
        ...
        ICurveTableGetter
    {
        ...
        internal partial class CurveTableRecordDataPayload
        {
            public int? REFLLocation;
        }

        private LazyPayload<CurveTableRecordDataPayload> _payload = null!;

        internal CurveTableRecordDataPayload Payload => _payload.Value;

        protected override void InitPayload(Lazy<bool> init)
        {
            base.InitPayload(init);
            _payload = new LazyPayload<CurveTableRecordDataPayload>(init, new CurveTableRecordDataPayload());
        }
