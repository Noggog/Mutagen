...
namespace Mutagen.Bethesda.Starfield
{
        ...
        IFaceMorphGetter
    {
        ...
        public String? FMRU
        {
            ...
            {
                var _data = _recordData; // Trigger lazy initialization if needed
                return _FMRULocation.HasValue ? BinaryStringUtility.ProcessWholeToZString(HeaderTranslation.ExtractSubrecordMemory(_data, _FMRULocation.Value, _package.MetaData.Constants), encoding: _package.MetaData.Encodings.NonTranslated) : default(string?);
            }
        }
        #endregion
        #region Name
        ...
        public String? FMRS
        {
            ...
            {
                var _data = _recordData; // Trigger lazy initialization if needed
                return _FMRSLocation.HasValue ? BinaryStringUtility.ProcessWholeToZString(HeaderTranslation.ExtractSubrecordMemory(_data, _FMRSLocation.Value, _package.MetaData.Constants), encoding: _package.MetaData.Encodings.NonTranslated) : default(string?);
            }
        }
        #endregion
