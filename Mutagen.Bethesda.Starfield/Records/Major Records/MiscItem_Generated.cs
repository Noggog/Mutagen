...
namespace Mutagen.Bethesda.Starfield
{
        ...
        IMiscItemGetter
    {
        ...
        #endregion
        public ReadOnlyMemorySlice<Byte>? FLAG => Payload.FLAGLocation.HasValue ? HeaderTranslation.ExtractSubrecordMemory(_recordData, Payload.FLAGLocation.Value, _package.MetaData.Constants) : default(ReadOnlyMemorySlice<byte>?);
