...
namespace Mutagen.Bethesda.Starfield
{
        ...
        IArtObjectGetter
    {
        ...
        #region Type
        private int _TypeLocation => Payload.DNAMLocation!.Value.Min;
        ...
        #endregion
        public IFormLinkNullableGetter<IEffectShaderGetter> EffectShader => FormLinkBinaryTranslation.Instance.NullableRecordOverlayFactory<IEffectShaderGetter>(_package, _recordData, Payload.EffectShaderLocation);

        internal partial class ArtObjectRecordDataPayload
        {
            ...
            public int? EffectShaderLocation;
        }

        private LazyPayload<ArtObjectRecordDataPayload> _payload = null!;

        internal ArtObjectRecordDataPayload Payload => _payload.Value;

        protected override void InitPayload(Lazy<bool> init)
        {
            base.InitPayload(init);
            _payload = new LazyPayload<ArtObjectRecordDataPayload>(init, new ArtObjectRecordDataPayload());
        }
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (type.TypeInt)
            {
                ...
                case RecordTypeInts.ENAM:
                {
                    _payload.Fields.EffectShaderLocation = (stream.Position - offset);
                    return (int)ArtObject_FieldIndex.EffectShader;
                }
                default:
