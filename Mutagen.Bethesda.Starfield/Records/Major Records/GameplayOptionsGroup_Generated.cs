...
namespace Mutagen.Bethesda.Starfield
{
        ...
        IGameplayOptionsGroupGetter
    {
        ...
        internal partial class GameplayOptionsGroupRecordDataPayload
        {
            public int? NameLocation;
        }

        private LazyPayload<GameplayOptionsGroupRecordDataPayload> _payload = null!;

        internal GameplayOptionsGroupRecordDataPayload Payload => _payload.Value;

        protected override void InitPayload(Lazy<bool> init)
        {
            base.InitPayload(init);
            _payload = new LazyPayload<GameplayOptionsGroupRecordDataPayload>(init, new GameplayOptionsGroupRecordDataPayload());
        }
