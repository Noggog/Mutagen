...
namespace Mutagen.Bethesda.Starfield
{
        ...
        IPlacedBeamGetter
    {
        ...
        internal partial class PlacedBeamRecordDataPayload
        {
        }

        private LazyPayload<PlacedBeamRecordDataPayload> _payload = null!;

        internal PlacedBeamRecordDataPayload Payload => _payload.Value;

        protected override void InitPayload(Lazy<bool> init)
        {
            base.InitPayload(init);
            _payload = new LazyPayload<PlacedBeamRecordDataPayload>(init, new PlacedBeamRecordDataPayload());
        }
