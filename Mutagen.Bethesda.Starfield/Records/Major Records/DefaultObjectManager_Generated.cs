...
namespace Mutagen.Bethesda.Starfield
{
        ...
        IDefaultObjectManagerGetter
    {
        ...
        public IReadOnlyList<IDefaultObjectUseGetter>? Objects => Payload.Objects;

        internal partial class DefaultObjectManagerRecordDataPayload
        {
            public IReadOnlyList<IDefaultObjectUseGetter>? Objects;
        }

        private LazyPayload<DefaultObjectManagerRecordDataPayload> _payload = null!;

        internal DefaultObjectManagerRecordDataPayload Payload => _payload.Value;

        protected override void InitPayload(Lazy<bool> init)
        {
            base.InitPayload(init);
            _payload = new LazyPayload<DefaultObjectManagerRecordDataPayload>(init, new DefaultObjectManagerRecordDataPayload());
        }
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (type.TypeInt)
            {
                case RecordTypeInts.DNAM:
                {
                    _payload.Fields.Objects = BinaryOverlayList.FactoryByStartIndexWithTrigger<IDefaultObjectUseGetter>(
                        stream: stream,
                        package: _package,
                        finalPos: finalPos,
                        itemLength: 8,
