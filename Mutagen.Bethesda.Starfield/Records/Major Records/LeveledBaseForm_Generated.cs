...
namespace Mutagen.Bethesda.Starfield
{
        ...
        ILeveledBaseFormGetter
    {
        ...
        public Single ChanceNone => Payload.ChanceNoneLocation.HasValue ? HeaderTranslation.ExtractSubrecordMemory(_recordData, Payload.ChanceNoneLocation.Value, _package.MetaData.Constants).Float() : default(Single);
        ...
        public IReadOnlyList<ILeveledBaseFormEntryGetter>? Entries => Payload.Entries;
        ...
        internal partial class LeveledBaseFormRecordDataPayload
        {
            ...
            public IReadOnlyList<ILeveledBaseFormEntryGetter>? Entries;
            public IReadOnlyList<IFilterKeywordChanceGetter>? FilterKeywordChances;
            public IModelGetter? Model;
        }

        private LazyPayload<LeveledBaseFormRecordDataPayload> _payload = null!;

        internal LeveledBaseFormRecordDataPayload Payload => _payload.Value;

        protected override void InitPayload(Lazy<bool> init)
        {
            base.InitPayload(init);
            _payload = new LazyPayload<LeveledBaseFormRecordDataPayload>(init, new LeveledBaseFormRecordDataPayload());
        }
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (type.TypeInt)
            {
                ...
                case RecordTypeInts.LLCT:
                {
                    _payload.Fields.Entries = BinaryOverlayList.FactoryByCountPerItem<ILeveledBaseFormEntryGetter>(
                        stream: stream,
                        package: _package,
                        countLength: 1,
