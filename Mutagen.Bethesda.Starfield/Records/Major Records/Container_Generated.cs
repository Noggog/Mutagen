...
namespace Mutagen.Bethesda.Starfield
{
        ...
        IContainerGetter
    {
        ...
        public IFormLinkNullableGetter<IFormListGetter> ContainsOnlyFilter => FormLinkBinaryTranslation.Instance.NullableRecordOverlayFactory<IFormListGetter>(_package, _recordData, Payload.ContainsOnlyFilterLocation);
        ...
        internal partial class ContainerRecordDataPayload
        {
            ...
            public int? ContainsOnlyFilterLocation;
        }
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (type.TypeInt)
            {
                ...
                case RecordTypeInts.ONAM:
                {
                    _payload.Fields.ContainsOnlyFilterLocation = (stream.Position - offset);
                    return (int)Container_FieldIndex.ContainsOnlyFilter;
                }
                case RecordTypeInts.XXXX:
                {
