...
namespace Mutagen.Bethesda.Starfield
{
        ...
        IStarGetter
    {
        ...
        #endregion
        #endregion
        public P3Float? BNAM => Payload.BNAMLocation.HasValue ? P3FloatBinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Read(HeaderTranslation.ExtractSubrecordMemory(_recordData, Payload.BNAMLocation.Value, _package.MetaData.Constants)) : default(P3Float?);
        ...
        public UInt32? ID => Payload.IDLocation.HasValue ? BinaryPrimitives.ReadUInt32LittleEndian(HeaderTranslation.ExtractSubrecordMemory(_recordData, Payload.IDLocation.Value, _package.MetaData.Constants)) : default(UInt32?);
        ...
        public IFormLinkNullableGetter<ISunPresetGetter> SunPreset => FormLinkBinaryTranslation.Instance.NullableRecordOverlayFactory<ISunPresetGetter>(_package, _recordData, Payload.SunPresetLocation);

        internal partial class StarRecordDataPayload
        {
            ...
            public int? SunPresetLocation;
        }

        private LazyPayload<StarRecordDataPayload> _payload = null!;

        internal StarRecordDataPayload Payload => _payload.Value;

        protected override void InitPayload(Lazy<bool> init)
        {
            base.InitPayload(init);
            _payload = new LazyPayload<StarRecordDataPayload>(init, new StarRecordDataPayload());
        }
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (type.TypeInt)
            {
                ...
                case RecordTypeInts.DNAM:
                {
                    _payload.Fields.IDLocation = (stream.Position - offset);
                    return (int)Star_FieldIndex.ID;
                }
                case RecordTypeInts.ENAM:
                {
                ...
                case RecordTypeInts.PNAM:
                {
                    _payload.Fields.SunPresetLocation = (stream.Position - offset);
                    return (int)Star_FieldIndex.SunPreset;
                }
                default:
