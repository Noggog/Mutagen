...
namespace Mutagen.Bethesda.Starfield
{
        ...
        IObjectSwapGetter
    {
        ...
        internal partial class ObjectSwapRecordDataPayload
        {
        }

        private LazyPayload<ObjectSwapRecordDataPayload> _payload = null!;

        internal ObjectSwapRecordDataPayload Payload => _payload.Value;

        protected override void InitPayload(Lazy<bool> init)
        {
            base.InitPayload(init);
            _payload = new LazyPayload<ObjectSwapRecordDataPayload>(init, new ObjectSwapRecordDataPayload());
        }
