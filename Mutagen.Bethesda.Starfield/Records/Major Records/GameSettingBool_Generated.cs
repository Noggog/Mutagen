...
namespace Mutagen.Bethesda.Starfield
{
        ...
        IGameSettingBoolGetter
    {
        ...
        private LazyPayload<GameSettingBoolRecordDataPayload> _payload = null!;

        internal GameSettingBoolRecordDataPayload Payload => _payload.Value;

        protected override void InitPayload(Lazy<bool> init)
        {
            base.InitPayload(init);
            _payload = new LazyPayload<GameSettingBoolRecordDataPayload>(init, new GameSettingBoolRecordDataPayload());
        }
