...
namespace Mutagen.Bethesda.Starfield
{
        ...
        IFloraModificationGetter
    {
        ...
        internal partial class FloraModificationRecordDataPayload
        {
        }

        private LazyPayload<FloraModificationRecordDataPayload> _payload = null!;

        internal FloraModificationRecordDataPayload Payload => _payload.Value;

        protected override void InitPayload(Lazy<bool> init)
        {
            base.InitPayload(init);
            _payload = new LazyPayload<FloraModificationRecordDataPayload>(init, new FloraModificationRecordDataPayload());
        }
