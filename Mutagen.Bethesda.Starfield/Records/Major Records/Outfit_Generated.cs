...
namespace Mutagen.Bethesda.Starfield
{
        ...
        IOutfitGetter
    {
        ...
        public IReadOnlyList<IFormLinkGetter<IOutfitTargetGetter>>? Items => Payload.Items;

        internal partial class OutfitRecordDataPayload
        {
            public IReadOnlyList<IFormLinkGetter<IOutfitTargetGetter>>? Items;
        }

        private LazyPayload<OutfitRecordDataPayload> _payload = null!;

        internal OutfitRecordDataPayload Payload => _payload.Value;

        protected override void InitPayload(Lazy<bool> init)
        {
            base.InitPayload(init);
            _payload = new LazyPayload<OutfitRecordDataPayload>(init, new OutfitRecordDataPayload());
        }
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (type.TypeInt)
            {
                case RecordTypeInts.INAM:
                {
                    _payload.Fields.Items = BinaryOverlayList.FactoryByStartIndexWithTrigger<IFormLinkGetter<IOutfitTargetGetter>>(
                        stream: stream,
                        package: _package,
                        finalPos: finalPos,
                        itemLength: 4,
