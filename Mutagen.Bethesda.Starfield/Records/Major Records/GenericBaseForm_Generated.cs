...
namespace Mutagen.Bethesda.Starfield
{
        ...
        IGenericBaseFormGetter
    {
        ...
        public IFormLinkNullableGetter<IGenericBaseFormTemplateGetter> Template => FormLinkBinaryTranslation.Instance.NullableRecordOverlayFactory<IGenericBaseFormTemplateGetter>(_package, _recordData, Payload.TemplateLocation);
        public IReadOnlyList<String> ObjectTemplateInstanceData => Payload.ObjectTemplateInstanceData ?? [];
        ...
        internal partial class GenericBaseFormRecordDataPayload
        {
            ...
            public IReadOnlyList<String> ObjectTemplateInstanceData = [];
        ...
        private LazyPayload<GenericBaseFormRecordDataPayload> _payload = null!;

        internal GenericBaseFormRecordDataPayload Payload => _payload.Value;

        protected override void InitPayload(Lazy<bool> init)
        {
            base.InitPayload(init);
            _payload = new LazyPayload<GenericBaseFormRecordDataPayload>(init, new GenericBaseFormRecordDataPayload());
        }
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (type.TypeInt)
            {
                ...
                case RecordTypeInts.STRV:
                {
                    _payload.Fields.ObjectTemplateInstanceData = BinaryOverlayList.FactoryByArray<String>(
