...
namespace Mutagen.Bethesda.Starfield
{
        ...
        IPlacedConeGetter
    {
        ...
        internal partial class PlacedConeRecordDataPayload
        {
        }

        private LazyPayload<PlacedConeRecordDataPayload> _payload = null!;

        internal PlacedConeRecordDataPayload Payload => _payload.Value;

        protected override void InitPayload(Lazy<bool> init)
        {
            base.InitPayload(init);
            _payload = new LazyPayload<PlacedConeRecordDataPayload>(init, new PlacedConeRecordDataPayload());
        }
