...
namespace Mutagen.Bethesda.Starfield
{
        ...
        INpcModificationGetter
    {
        ...
        internal partial class NpcModificationRecordDataPayload
        {
        }

        private LazyPayload<NpcModificationRecordDataPayload> _payload = null!;

        internal NpcModificationRecordDataPayload Payload => _payload.Value;

        protected override void InitPayload(Lazy<bool> init)
        {
            base.InitPayload(init);
            _payload = new LazyPayload<NpcModificationRecordDataPayload>(init, new NpcModificationRecordDataPayload());
        }
