...
namespace Mutagen.Bethesda.Starfield
{
        ...
        IAnimationSoundTagSetGetter
    {
        ...
        public IReadOnlyList<IAnimationSoundTagGetter>? Tags => Payload.Tags;

        internal partial class AnimationSoundTagSetRecordDataPayload
        {
            public IReadOnlyList<IAnimationSoundTagGetter>? Tags;
        }

        private LazyPayload<AnimationSoundTagSetRecordDataPayload> _payload = null!;

        internal AnimationSoundTagSetRecordDataPayload Payload => _payload.Value;

        protected override void InitPayload(Lazy<bool> init)
        {
            base.InitPayload(init);
            _payload = new LazyPayload<AnimationSoundTagSetRecordDataPayload>(init, new AnimationSoundTagSetRecordDataPayload());
        }
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (type.TypeInt)
            {
                ...
                case RecordTypeInts.STMS:
                {
                    _payload.Fields.Tags = BinaryOverlayList.FactoryByCountPerItem<IAnimationSoundTagGetter>(
                        stream: stream,
                        package: _package,
                        countLength: 4,
