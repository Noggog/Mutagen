...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        IPlacedBarrierGetter
    {
        ...
        internal partial class PlacedBarrierRecordDataPayload
        {
        }

        private LazyPayload<PlacedBarrierRecordDataPayload> _payload = null!;

        internal PlacedBarrierRecordDataPayload Payload => _payload.Value;

        protected override void InitPayload(Lazy<bool> init)
        {
            base.InitPayload(init);
            _payload = new LazyPayload<PlacedBarrierRecordDataPayload>(init, new PlacedBarrierRecordDataPayload());
        }
