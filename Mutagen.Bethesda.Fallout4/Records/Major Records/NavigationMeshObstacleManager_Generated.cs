...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        INavigationMeshObstacleManagerGetter
    {
        ...
        internal partial class NavigationMeshObstacleManagerRecordDataPayload
        {
            public IReadOnlyList<INavigationMeshObstacleManagerSubObjectGetter> SubObjects = [];
        }

        private LazyPayload<NavigationMeshObstacleManagerRecordDataPayload> _payload = null!;

        internal NavigationMeshObstacleManagerRecordDataPayload Payload => _payload.Value;

        protected override void InitPayload(Lazy<bool> init)
        {
            base.InitPayload(init);
            _payload = new LazyPayload<NavigationMeshObstacleManagerRecordDataPayload>(init, new NavigationMeshObstacleManagerRecordDataPayload());
        }
