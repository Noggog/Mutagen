...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        IFormListGetter
    {
        ...
        #endregion
        #endregion
        public IReadOnlyList<IFormLinkGetter<IFallout4MajorRecordGetter>> Items => Payload.Items ?? [];

        internal partial class FormListRecordDataPayload
        {
            public int? NameLocation;
            public IReadOnlyList<IFormLinkGetter<IFallout4MajorRecordGetter>> Items = [];
        }
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (type.TypeInt)
            {
                ...
                case RecordTypeInts.LNAM:
                {
                    _payload.Fields.Items = BinaryOverlayList.FactoryByArray<IFormLinkGetter<IFallout4MajorRecordGetter>>(
