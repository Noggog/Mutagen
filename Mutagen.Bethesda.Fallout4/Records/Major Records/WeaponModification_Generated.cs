...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        IWeaponModificationGetter
    {
        ...
        internal partial class WeaponModificationRecordDataPayload
        {
        }

        private LazyPayload<WeaponModificationRecordDataPayload> _payload = null!;

        internal WeaponModificationRecordDataPayload Payload => _payload.Value;

        protected override void InitPayload(Lazy<bool> init)
        {
            base.InitPayload(init);
            _payload = new LazyPayload<WeaponModificationRecordDataPayload>(init, new WeaponModificationRecordDataPayload());
        }
