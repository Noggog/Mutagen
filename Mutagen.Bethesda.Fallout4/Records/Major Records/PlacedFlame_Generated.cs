...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        IPlacedFlameGetter
    {
        ...
        internal partial class PlacedFlameRecordDataPayload
        {
        }

        private LazyPayload<PlacedFlameRecordDataPayload> _payload = null!;

        internal PlacedFlameRecordDataPayload Payload => _payload.Value;

        protected override void InitPayload(Lazy<bool> init)
        {
            base.InitPayload(init);
            _payload = new LazyPayload<PlacedFlameRecordDataPayload>(init, new PlacedFlameRecordDataPayload());
        }
