...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        IFootstepSetGetter
    {
        ...
        internal partial class FootstepSetRecordDataPayload
        {
        }

        private LazyPayload<FootstepSetRecordDataPayload> _payload = null!;

        internal FootstepSetRecordDataPayload Payload => _payload.Value;

        protected override void InitPayload(Lazy<bool> init)
        {
            base.InitPayload(init);
            _payload = new LazyPayload<FootstepSetRecordDataPayload>(init, new FootstepSetRecordDataPayload());
        }
