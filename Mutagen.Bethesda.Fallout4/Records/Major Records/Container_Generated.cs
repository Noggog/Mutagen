...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        IContainerGetter
    {
        ...
        #endregion
        #region Weight
        private int _WeightLocation => Payload.DATALocation!.Value.Min + 0x1;
        ...
        public IFormLinkNullableGetter<ISoundDescriptorGetter> TakeAllSound => FormLinkBinaryTranslation.Instance.NullableRecordOverlayFactory<ISoundDescriptorGetter>(_package, _recordData, Payload.TakeAllSoundLocation);
        public IFormLinkNullableGetter<IFormListGetter> FilterList => FormLinkBinaryTranslation.Instance.NullableRecordOverlayFactory<IFormListGetter>(_package, _recordData, Payload.FilterListLocation);
        ...
        internal partial class ContainerRecordDataPayload
        {
            ...
            public int? TakeAllSoundLocation;
            public int? FilterListLocation;
        }
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (type.TypeInt)
            {
                ...
                case RecordTypeInts.TNAM:
                {
                    _payload.Fields.TakeAllSoundLocation = (stream.Position - offset);
                    return (int)Container_FieldIndex.TakeAllSound;
                }
                case RecordTypeInts.ONAM:
                {
                    _payload.Fields.FilterListLocation = (stream.Position - offset);
                    return (int)Container_FieldIndex.FilterList;
                }
                case RecordTypeInts.XXXX:
                {
