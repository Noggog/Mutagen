...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        IStoryManagerBranchNodeGetter
    {
        ...
        internal partial class StoryManagerBranchNodeRecordDataPayload
        {
            public int? FlagsLocation;
            public int? MaxConcurrentQuestsLocation;
        }

        private LazyPayload<StoryManagerBranchNodeRecordDataPayload> _payload = null!;

        internal StoryManagerBranchNodeRecordDataPayload Payload => _payload.Value;

        protected override void InitPayload(Lazy<bool> init)
        {
            base.InitPayload(init);
            _payload = new LazyPayload<StoryManagerBranchNodeRecordDataPayload>(init, new StoryManagerBranchNodeRecordDataPayload());
        }
