...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        IArmorModificationGetter
    {
        ...
        internal partial class ArmorModificationRecordDataPayload
        {
        }

        private LazyPayload<ArmorModificationRecordDataPayload> _payload = null!;

        internal ArmorModificationRecordDataPayload Payload => _payload.Value;

        protected override void InitPayload(Lazy<bool> init)
        {
            base.InitPayload(init);
            _payload = new LazyPayload<ArmorModificationRecordDataPayload>(init, new ArmorModificationRecordDataPayload());
        }
