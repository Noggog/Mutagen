...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        IMovableStaticGetter
    {
        ...
        public Boolean OnLocalMap => Payload.OnLocalMapLocation.HasValue ? HeaderTranslation.ExtractSubrecordMemory(_recordData, Payload.OnLocalMapLocation.Value, _package.MetaData.Constants)[0] >= 1 : default(Boolean);
        ...
        internal partial class MovableStaticRecordDataPayload
        {
            ...
            public int? OnLocalMapLocation;
            public int? LoopingSoundLocation;
        }

        private LazyPayload<MovableStaticRecordDataPayload> _payload = null!;

        internal MovableStaticRecordDataPayload Payload => _payload.Value;

        protected override void InitPayload(Lazy<bool> init)
        {
            base.InitPayload(init);
            _payload = new LazyPayload<MovableStaticRecordDataPayload>(init, new MovableStaticRecordDataPayload());
        }
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (type.TypeInt)
            {
                ...
                case RecordTypeInts.DATA:
                {
                    _payload.Fields.OnLocalMapLocation = (stream.Position - offset);
                    return (int)MovableStatic_FieldIndex.OnLocalMap;
                }
                case RecordTypeInts.SNAM:
                {
