...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        IImpactGetter
    {
        ...
        public IFormLinkNullableGetter<IExplosionGetter> FootstepExplosion => FormLinkBinaryTranslation.Instance.NullableRecordOverlayFactory<IExplosionGetter>(_package, _recordData, Payload.FootstepExplosionLocation);
        ...
        internal partial class ImpactRecordDataPayload
        {
            ...
            public int? FootstepExplosionLocation;
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (type.TypeInt)
            {
                ...
                case RecordTypeInts.NAM3:
                {
                    _payload.Fields.FootstepExplosionLocation = (stream.Position - offset);
                    return (int)Impact_FieldIndex.FootstepExplosion;
                }
                case RecordTypeInts.NAM2:
                {
