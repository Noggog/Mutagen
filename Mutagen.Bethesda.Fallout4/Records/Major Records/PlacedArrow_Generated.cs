...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        IPlacedArrowGetter
    {
        ...
        internal partial class PlacedArrowRecordDataPayload
        {
        }

        private LazyPayload<PlacedArrowRecordDataPayload> _payload = null!;

        internal PlacedArrowRecordDataPayload Payload => _payload.Value;

        protected override void InitPayload(Lazy<bool> init)
        {
            base.InitPayload(init);
            _payload = new LazyPayload<PlacedArrowRecordDataPayload>(init, new PlacedArrowRecordDataPayload());
        }
