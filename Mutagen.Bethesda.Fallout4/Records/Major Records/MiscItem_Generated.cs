...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        IMiscItemGetter
    {
        ...
        #endregion
        public IReadOnlyList<IMiscItemComponentGetter>? Components => Payload.Components;
        public IReadOnlyList<Byte>? ComponentDisplayIndices => Payload.ComponentDisplayIndices;

        internal partial class MiscItemRecordDataPayload
        {
            ...
            public IReadOnlyList<IMiscItemComponentGetter>? Components;
            public IReadOnlyList<Byte>? ComponentDisplayIndices;
        }

        private LazyPayload<MiscItemRecordDataPayload> _payload = null!;

        internal MiscItemRecordDataPayload Payload => _payload.Value;

        protected override void InitPayload(Lazy<bool> init)
        {
            base.InitPayload(init);
            _payload = new LazyPayload<MiscItemRecordDataPayload>(init, new MiscItemRecordDataPayload());
        }
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (type.TypeInt)
            {
                ...
                case RecordTypeInts.CVPA:
                {
                    _payload.Fields.Components = BinaryOverlayList.FactoryByStartIndexWithTrigger<IMiscItemComponentGetter>(
                        stream: stream,
                        package: _package,
                        finalPos: finalPos,
                        itemLength: 8,
