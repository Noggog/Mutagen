...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        IFootstepGetter
    {
        ...
        public IFormLinkGetter<IImpactDataSetGetter> ImpactDataSet => FormLinkBinaryTranslation.Instance.NullableRecordOverlayFactory<IImpactDataSetGetter>(_package, _recordData, Payload.ImpactDataSetLocation);
        public String Tag => Payload.TagLocation.HasValue ? BinaryStringUtility.ProcessWholeToZString(HeaderTranslation.ExtractSubrecordMemory(_recordData, Payload.TagLocation.Value, _package.MetaData.Constants), encoding: _package.MetaData.Encodings.NonTranslated) : string.Empty;

        internal partial class FootstepRecordDataPayload
        {
            public int? ImpactDataSetLocation;
            public int? TagLocation;
        }

        private LazyPayload<FootstepRecordDataPayload> _payload = null!;

        internal FootstepRecordDataPayload Payload => _payload.Value;

        protected override void InitPayload(Lazy<bool> init)
        {
            base.InitPayload(init);
            _payload = new LazyPayload<FootstepRecordDataPayload>(init, new FootstepRecordDataPayload());
        }
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (type.TypeInt)
            {
                ...
                case RecordTypeInts.ANAM:
                {
                    _payload.Fields.TagLocation = (stream.Position - offset);
                    return (int)Footstep_FieldIndex.Tag;
                }
                default:
