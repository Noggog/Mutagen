...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        IIngredientGetter
    {
        ...
        public IFormLinkNullableGetter<IEquipTypeGetter> EquipType => FormLinkBinaryTranslation.Instance.NullableRecordOverlayFactory<IEquipTypeGetter>(_package, _recordData, Payload.EquipTypeLocation);
        ...
        #endregion
        #region IngredientValue
        private int _IngredientValueLocation => Payload.ENITLocation!.Value.Min;
        private bool _IngredientValue_IsSet => Payload.ENITLocation.HasValue;
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (type.TypeInt)
            {
                ...
                case RecordTypeInts.ETYP:
                {
                    _payload.Fields.EquipTypeLocation = (stream.Position - offset);
                    return (int)Ingredient_FieldIndex.EquipType;
                }
                case RecordTypeInts.YNAM:
                {
