...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        IPlacedMissileGetter
    {
        ...
        internal partial class PlacedMissileRecordDataPayload
        {
        }

        private LazyPayload<PlacedMissileRecordDataPayload> _payload = null!;

        internal PlacedMissileRecordDataPayload Payload => _payload.Value;

        protected override void InitPayload(Lazy<bool> init)
        {
            base.InitPayload(init);
            _payload = new LazyPayload<PlacedMissileRecordDataPayload>(init, new PlacedMissileRecordDataPayload());
        }
