...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        IAmmunitionGetter
    {
        ...
        public ReadOnlyMemorySlice<Byte>? ModelInfo => Payload.ModelInfoLocation.HasValue ? HeaderTranslation.ExtractSubrecordMemory(_recordData, Payload.ModelInfoLocation.Value, _package.MetaData.Constants) : default(ReadOnlyMemorySlice<byte>?);
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (type.TypeInt)
            {
                ...
                case RecordTypeInts.NAM2:
                {
                    _payload.Fields.ModelInfoLocation = (stream.Position - offset);
                    return (int)Ammunition_FieldIndex.ModelInfo;
                }
                default:
