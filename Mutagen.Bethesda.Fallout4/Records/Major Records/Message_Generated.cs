...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        IMessageGetter
    {
        ...
        public String? Swf => Payload.SwfLocation.HasValue ? BinaryStringUtility.ProcessWholeToZString(HeaderTranslation.ExtractSubrecordMemory(_recordData, Payload.SwfLocation.Value, _package.MetaData.Constants), encoding: _package.MetaData.Encodings.NonTranslated) : default(string?);
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (type.TypeInt)
            {
                ...
                case RecordTypeInts.SNAM:
                {
                    _payload.Fields.SwfLocation = (stream.Position - offset);
                    return (int)Message_FieldIndex.Swf;
                }
                case RecordTypeInts.NNAM:
                {
