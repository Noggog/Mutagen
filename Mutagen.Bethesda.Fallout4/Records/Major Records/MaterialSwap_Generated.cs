...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        IMaterialSwapGetter
    {
        ...
        #endregion
        public IReadOnlyList<IMaterialSubstitutionGetter> Substitutions => Payload.Substitutions ?? [];

        internal partial class MaterialSwapRecordDataPayload
        {
            public IReadOnlyList<IMaterialSubstitutionGetter> Substitutions = [];
        }

        private LazyPayload<MaterialSwapRecordDataPayload> _payload = null!;

        internal MaterialSwapRecordDataPayload Payload => _payload.Value;

        protected override void InitPayload(Lazy<bool> init)
        {
            base.InitPayload(init);
            _payload = new LazyPayload<MaterialSwapRecordDataPayload>(init, new MaterialSwapRecordDataPayload());
        }
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (type.TypeInt)
            {
                ...
                case RecordTypeInts.CNAM:
                {
                    _payload.Fields.Substitutions = this.ParseRepeatedTypelessSubrecord<IMaterialSubstitutionGetter>(
                        stream: stream,
                        translationParams: translationParams,
