...
public class SeparatedMastersTesting
{
        ...
        ModKey modBKey)
    {
        ...
        var originatingSelfNpc = originating.Npcs.AddNew();
        originatingSelfNpc.Template.SetTo(originatingSelfNpc);
            ...
            originatingNpc.FormKey);
        {
            ...
            var origSelfNpcFrame = ReadFrame(stream, locs, originatingSelfNpc.FormKey);
            origSelfNpcFrame.FormID.Raw.Should().Be(FormID.Factory(MasterStyle.Full, 2, originatingSelfNpc.FormKey.ID).Raw);
            var npcSelfTplt = origSelfNpcFrame.FindSubrecord(RecordTypes.TPLT);
            npcSelfTplt.AsFormID().Should().Be(FormID.Factory(MasterStyle.Full, 2, originatingSelfNpc.FormKey.ID));
        ...
        var reimportSelfNpc = reimport.Npcs[originatingSelfNpc.FormKey];
        reimportSelfNpc.Template.FormKey.Should().Be(originatingSelfNpc.FormKey);
        ...
        ModKey mediumBKey)
    {
        ...
        var originatingSelfNpc = originating.Npcs.AddNew();
        originatingSelfNpc.InheritsSoundsFrom.SetTo(originatingSelfNpc);
        var originatingNpc = originating.Npcs.AddNew();
            ...
            mediumModBAim.FormKey);
        {
            ...
            var origSelfNpcFrame = ReadFrame(stream, locs, originatingSelfNpc.FormKey);
            origSelfNpcFrame.FormID.Raw
                .Should().Be(FormID.Factory(MasterStyle.Full, 2, originatingSelfNpc.FormKey.ID).Raw);
            var origSelfNpcCscr = origSelfNpcFrame.FindSubrecord(RecordTypes.CSCR);
            origSelfNpcCscr.AsFormID()
                .Should().Be(FormID.Factory(MasterStyle.Full, 2, originatingSelfNpc.FormKey.ID));
            var origNpcFrame = ReadFrame(stream, locs, originatingNpc.FormKey);
        ...
        reimport.Npcs.Select(x => x.FormKey).Should().Equal(
            ...
            originatingMediumNpc.FormKey);
        var reimportSelfNpc = reimport.Npcs[originatingSelfNpc.FormKey];
        reimportSelfNpc.InheritsSoundsFrom.FormKey.Should().Be(originatingSelfNpc.FormKey);
        var reimportNpc = reimport.Npcs[originatingNpc.FormKey];
    ...
    [Theory, MutagenAutoData]
    public void SeparatedOnALightMaster(
        IFileSystem fileSystem,
        DirectoryPath existingDir,
        ModKey originatingKey,
        ModKey modAKey,
    ...
    {
        var originating = new StarfieldMod(originatingKey, StarfieldRelease.Starfield);
        originating.IsLightMaster = true;
        var modA = new StarfieldMod(modAKey, StarfieldRelease.Starfield);
        var modB = new StarfieldMod(modBKey, StarfieldRelease.Starfield);
        var lightModA = new StarfieldMod(lightAKey, StarfieldRelease.Starfield);
        var lightModB = new StarfieldMod(lightBKey, StarfieldRelease.Starfield);
            ...
            mediumModBAim.FormKey);
        {
            ...
            var origSelfNpcCscr = origSelfNpcFrame.FindSubrecord(RecordTypes.CSCR);
            origSelfNpcCscr.AsFormID()
                .Should().Be(FormID.Factory(MasterStyle.Light, 2, originatingSelfNpc.FormKey.ID));
            var origNpcFrame = ReadFrame(stream, locs, originatingNpc.FormKey);
            origNpcFrame.FormID.Raw
                .Should().Be(FormID.Factory(MasterStyle.Full, 2, originatingNpc.FormKey.ID).Raw);
            var npcCscr = origNpcFrame.FindSubrecord(RecordTypes.CSCR);
    ...
    [Theory, MutagenAutoData]
    public void SeparatedOnAMediumMaster(
        IFileSystem fileSystem,
        DirectoryPath existingDir,
        ModKey originatingKey,
        ModKey modAKey,
    ...
    {
        var originating = new StarfieldMod(originatingKey, StarfieldRelease.Starfield);
        originating.IsMediumMaster = true;
        var modA = new StarfieldMod(modAKey, StarfieldRelease.Starfield);
        var modB = new StarfieldMod(modBKey, StarfieldRelease.Starfield);
        var lightModA = new StarfieldMod(lightAKey, StarfieldRelease.Starfield);
        var lightModB = new StarfieldMod(lightBKey, StarfieldRelease.Starfield);
            ...
            mediumModBAim.FormKey);
        {
            ...
            var origSelfNpcCscr = origSelfNpcFrame.FindSubrecord(RecordTypes.CSCR);
            origSelfNpcCscr.AsFormID()
                .Should().Be(FormID.Factory(MasterStyle.Medium, 2, originatingSelfNpc.FormKey.ID));
            var origNpcFrame = ReadFrame(stream, locs, originatingNpc.FormKey);
            origNpcFrame.FormID.Raw
                .Should().Be(FormID.Factory(MasterStyle.Full, 2, originatingNpc.FormKey.ID).Raw);
            var npcCscr = origNpcFrame.FindSubrecord(RecordTypes.CSCR);
